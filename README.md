...
1. **Safety Topic** — months start empty. Tap a month to open the talk on the **right**. Choose a talk, or drop a PDF and pick the month. **Delete topic** clears that month without deleting signatures.
